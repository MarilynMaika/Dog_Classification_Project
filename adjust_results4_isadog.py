    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            if line not in dognames_dic:
                dognames_dic[line] = 1  # Add dog name to dictionary
    ...
    #for key in results_dic:
        ...
        if pet_label in dognames_dic:
            if classifier_label in dognames_dic:
                ...
                results_dic[key].extend((1, 0))  # Pet is a dog, classifier is NOT a dog

        # Pet Image Label IS NOT a Dog
        else:
            if classifier_label in dognames_dic:
                results_dic[key].extend((0, 1))  # Pet is NOT a dog, classifier IS a dog
            else:
