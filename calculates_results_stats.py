...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1:
            ...
            if results_dic[key][4] == 1:
                ...
                results_stats_dic['n_correct_notdogs'] += 1  if results_dic[key][4] == 0 else 0
    ...
    #results_stats_dic['pct_match'] = results_stats_dic['n_match']/results_stats_dic['n_dogs_img']*100.0
