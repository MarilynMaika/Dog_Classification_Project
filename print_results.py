...
def print_results(results_dic, results_stats_dic, model, 
 ...
 # Prints summary statistics (percentages) on Model Run
    print("\n\n*** Results Percentage Summary for CNN Model Architecture",model.upper(),"***")
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
                ...
                is_dog_pet = results_dic[key][2]  
                is_dog_classifier = results_dic[key][3]
                
               # if (is_dog_pet == 1 and is_dog_classifier == 0) or (is_dog_pet == 0 and is_dog_classifier == 1):
